  ...
  const socialLinks = [
    {
      name: "Facebook",
      color: "bg-[#1877F2]",
      href: "https://www.facebook.com/yenommarket/",
    ...
    },
    {
      name: "YouTube",
      color: "bg-[#FF0000]",
      href: "https://www.youtube.com/channel/UCZm5VY4nr-zWCtqmO-ctt4Q",
      d: "M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 00-1.94 2C1 8.11 1 12 1 12s0 3.89.46 5.58a2.78 2.78 0 001.94 2c1.72.42 8.6.42 8.6.42s6.88 0 8.6-.42a2.78 2.78 0 001.94-2C23 15.89 23 12 23 12s0-3.89-.46-5.58z M9.75 15.02l5.75-3.02-5.75-3.02v6.04z",
    },
    {
      name: "Instagram",
      color:
        "bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]",
      href: "https://www.instagram.com/yenom__market/",
      isInstagram: true,
    },
  ];
